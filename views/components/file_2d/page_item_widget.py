...
class PageItemWidget(QtWidgets.QGraphicsItemGroup):
    ...
    def __addPageNumber(self):
        ...
        text_item.setPos(
            self.__opts["width"] * 0.5, 
            self.__opts["height"] + self.__opts["y_offset"]
            )
        self.addToGroup(text_item)
    ...
    def paddedBoundingRect(self, padding: QtCore.QSizeF = QtCore.QSizeF(1.0, 1.0)) -> QtCore.QRectF:
        """
        ...
        rect.adjust(-padding.width(), -padding.height(), padding.width(), padding.height())
        return rect
    # endregion
